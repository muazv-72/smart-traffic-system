...
from backend.state import LIVE_TRAFFIC_DATA, HUB_STATES, HUB_MODE
                ...
                for hub in hubs:
                    ...
                    if st["state"] == "SCAN":
                        ...
                        for cam in cameras:
                            ...
                            score, count, is_emergency = detect_vehicles_and_calculate_score(cam)
                            ...
                            if is_emergency:
                                emergency_cam = cam
                                print(f"[{hub.name}] 🚑 AMBULANCE DETECTED IN {cam.name}")
                                break
                        ...
                        if emergency_cam:
                            ...
                            print(f"[{hub.name}] 🚑 AMBULANCE DETECTED IN {current_cam.name}")
                            print(f"[{hub.name}] 🚦 GREEN GIVEN TO {current_cam.name} (AMBULANCE PRIORITY)")
                            ...
                            print(f"[{hub.name}] 🚦 GREEN GIVEN TO {current_cam.name}")
